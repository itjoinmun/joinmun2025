...
const MunForm = ({ slug, index = 0 }: { slug: DelegateOptions; index?: number }) => {
  ...
  const formFields: FormFieldConfig[] = [
    ...
    },
    {
      ...
      label: "Firstpreferred council",
      placeholder: "First Preferred Council name",
    ...
    },
    {
      ...
      placeholder: "Fill your first preferred council reason",
    ...
    },
    {
      ...
      placeholder: "Fill your first preferred country",
    ...
    },
    {
      ...
      placeholder: "Fill your second preferred council",
      validation: z.string().min(1, "Preferred council is required"),
    ...
    },
    {
      ...
      placeholder: "Fill your second preferred council reason",
      validation: z.string().min(1, "Reason is required"),
    ...
    },
    {
      ...
      placeholder: "Fill your second preferred country reason",
      validation: z.string().min(1, "Country is required"),
    ...
    },
    {
      ...
      placeholder: "Fill your third preferred council",
      validation: z.string().min(1, "Preferred council is required"),
    ...
    },
    {
      ...
      placeholder: "Fill your third preferred council reason",
      validation: z.string().min(1, "Reason is required"),
    ...
    },
    {
      ...
      placeholder: "Third preferred country",
      validation: z.string().min(1, "Country is required"),
