...
export interface Config {
  ...
  collections: {
    ...
    media: Media;
    articles: Article;
    'media-publishers': MediaPublisher;
  ...
  collectionsSelect: {
    ...
    'media-publishers': MediaPublishersSelect<false> | MediaPublishersSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "media-publishers_select".
 */
